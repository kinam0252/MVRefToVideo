...
TRAINING_DATASET_CONFIG="examples/training/sft/wan/mvref_lora/training.json"
VALIDATION_DATASET_FILE="examples/training/sft/wan/mvref_lora/validation.json"
